        ...
        <main className="flex-1 w-full h-screen mt-20 mb-20">
            ...
            <div className="relative w-[96%] mx-auto h-[60vh] overflow-hidden rounded-3xl">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center p-6 text-center">
                    <h3 className="mb-2 text-4xl font-bold text-primary drop-shadow-lg md:text-6xl md:mb-4">
                        Visit Our Gym
                    </h3>
                    <p className="max-w-md mb-4 text-sm font-semibold text-primary drop-shadow-lg text-bold md:mb-6">
