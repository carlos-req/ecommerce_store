  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          onClick={() => {}}
          className="absolute z-30 hidden transform -translate-x-1/2 -translate-y-1/2 top-1/3 left-1/2 group-hover:block"
        >
          <FaPlus size={40} color="#fff" />
        </button>
        <div className="absolute z-20 hidden md:h-[13.75rem] py-20 transform -translate-x-1/2 -translate-y-1/2 w-[7.1em] md:w-[11.1rem] opacity-80 rounded-2xl top-1/2 left-1/2 group-hover:block bg-gray-950 backdrop-saturate-200 backdrop-blur-xs bg-opacity-60"></div>
